...
export const game5: Game = {
  ...
  felipeOutroVideo:   "/videos/felipe-game5.mp4",
  nextGame: {
  ...
  scenes: [
    ...
    // ── LEARN 1: Claude vs. ChatGPT — Actually Different Tools ───────────────
    {
      ...
      scenarioText: "Jordan opened Claude expecting ChatGPT — and it immediately pushed back on her assumption. The difference isn't speed: ChatGPT goes wide, Claude goes deep.",
    ...
    // ── LEARN 2: Projects and Custom Instructions ─────────────────────────────
    {
      ...
      scenarioText: "Every morning Jordan copy-pasted the same paragraph of context into Claude — and Sam watched in silence before finally saying 'you know you can fix that permanently, right?' Claude Projects let Jordan write custom instructions once and never retype them again.",
    ...
    // ── LEARN 3: How to Get Claude to Actually Push Back ─────────────────────
    {
      ...
      scenarioText: "Sam asked Jordan one question — 'Have you ever told Claude to disagree with you?' — and Jordan went quiet. Claude defaults to agreeable; tell it explicitly to push back and it becomes an entirely different tool.",
