...
export const game2: Game = {
  ...
  scenes: [
      ...
      choices: [
        {
          ...
          wrongStoryText: "Zoe's shoulders sag. Diana Voss leans back: 'Zoe, we'd be throwing away decades of musical wisdom. AI is easy to teach, but taste takes a lifetime. That's a bad business decision.'",
          wrongFeedback: "Discarding **Musical Judgment** to gain **AI Efficiency** wastes the scarce resource — judgment takes years, **AI Literacy** takes weeks.",
        },
        {
          label:    "B",
        ...
        },
        {
          ...
          wrongStoryText: "Zoe looks down. Diana Voss sighs: 'Efficiency with poor judgment just makes bad music faster. In this room, we reward hits, not speed.'",
          wrongFeedback: "**Efficiency** without **Creative Direction** just scales mediocrity faster — the market rewards great output, not fast output.",
        },
        {
          label:    "D",
          ...
          wrongStoryText: "Zoe's hands fidget. Diana Voss shakes her head: 'Genre doesn't change the equation. The human in the loop still decides the quality of what comes out.'",
          wrongFeedback: "**Genre** is surface-level — **Human Judgment** determining the quality of **AI-Directed Output** is constant across every creative domain.",
        },
      ],
    },

    {
      ...
      promptChallenge: {
        context:
          "Zoe wants to use Claude to analyze a standard session drumming contract. She wants to see if there are any clauses that allow the label to use her recorded drum stems to train an AI model without her permission or additional royalties. She has a text file of the contract.",
        goal:
          "Write a prompt that asks Claude to review the contract specifically looking for clauses related to AI training, data rights, stem usage, and derivative works, requesting a summary of any risks found.",
        placeholder: "Write Zoe's prompt to analyze the contract for AI training clauses..."
      },
      xpAward: 100,
    },

    // ─── NEAR-TRANSFER: Same Clarity, Different Room ─────────────────────────
    {
      id:       "w2-near-transfer",
      type:     "learn",
      ...
      xpAward:  0,
      concept: {
        title: "Same Clarity. Different Room.",
        body:  "Marcus leads product at a healthcare startup. His board kept asking 'can the AI diagnose patients?' — the wrong question, rooted in the same myths Zoe debunked. He stopped defending the tool and started correcting the frame: 'Our AI doesn't diagnose — it flags statistical anomalies for physician review. It has no judgment, no awareness, and it amplifies whatever bias is in the training set. Here's how we audit for that.' The board's fear turned into confidence. Same AI. Different mental model in the room.",
      },
      learnHighlight: "Clearing the myths isn't just about understanding AI. It's about being the person who can make others understand it.",
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      bossQuestions: [
          ...
          choices: [
            {
              ...
              wrongStoryText: "Diana raises an eyebrow. 'Outdated data is secondary. The real problem is LLMs don't query Spotify. They generate plausible text.'",
          wrongFeedback: "**Training Cutoffs** matter — but the deeper flaw is **Hallucination**: LLMs generate confident-sounding text without verifying facts against real data.",
            },
            {
              label:    "B",
            ...
            },
            {
              ...
              wrongStoryText: "Diana frowns. 'Specialized tools help, but A&R needs to check data themselves first.'",
          wrongFeedback: "Better tools help — but the core lesson is **AI Literacy**: knowing what class of tool you're using and what it fundamentally cannot verify.",
            },
            {
              label:    "D",
              ...
              wrongStoryText: "Diana sighs. 'A complete ban on AI is an overreaction. Use it for synthesis, verify specific numbers.'",
          wrongFeedback: "AI is a powerful tool for synthesis and ideation — the real skill is knowing its **Capability Boundaries**, not avoiding it entirely.",
            },
          ],
        },
          ...
          choices: [
            {
              ...
              wrongStoryText: "Diana winces. 'Historical performance data carries human bias. The AI didn't find \"objective\" quality, it found structural privilege.'",
          wrongFeedback: "**Training Data Bias** means AI learns structural advantage — who got promoted — not objective musical quality or true listener preference.",
            },
            {
              label:    "B",
            ...
            },
            {
              ...
              wrongStoryText: "Diana shakes her head. 'It's not a programming bug. The algorithm did exactly what it was told. The training data was biased.'",
          wrongFeedback: "There may be no bug — **Biased Training Data** produces exactly the output it was built on; the fix lives upstream in the data, not the code.",
            },
            {
              label:    "D",
              ...
              wrongStoryText: "Diana scowls. 'We can't just pass the buck to HR. Designers must understand algorithmic bias at the source.'",
          wrongFeedback: "Compliance matters, but without understanding **Algorithmic Bias**, legal teams can't fix what the AI is actually doing at the source.",
            },
          ],
        },
        ...
        // Round 3 — Creativity Myth
        {
          ...
          choices: [
            {
              ...
              wrongStoryText: "Diana looks disappointed. 'The producer selected the prompt, curated the audio, and chose to stop at this version. Curation is creative.'",
          wrongFeedback: "Every prompt, selection, and iteration is a creative decision — **Human Creative Direction** is present even when AI executes the output.",
            },
            {
              label:    "B",
            ...
            },
            {
              ...
              wrongStoryText: "Diana rubs her temples. 'Philosophical ambiguity aside, humans made the choices here. The choice is the creativity.'",
          wrongFeedback: "Legal ambiguity is real but separate — **Creative Attribution** is observable now: humans made choices, and choices are creativity.",
            },
            {
              label:    "D",
          ...
          wrongFeedback: "Transparency and **Creative Attribution** are separate questions — disclosing AI use doesn't resolve who contributed the creative vision.",
          wrongStoryText: "Zoe types 'AI-generated' and pauses. The console replies: 'You labeled the vehicle. You still haven't named the driver.'",
            },
          ],
        },
        ...
        // Round 4 — Vague Prompt / Specificity
        {
          ...
          choices: [
            {
              ...
              wrongStoryText: "Diana sighs. 'Claude is excellent at voice capture, but you didn't give it any examples to anchor to.'",
          wrongFeedback: "The model isn't the problem — **Prompt Specificity** is; without real examples, any AI defaults to the voice of everyone who asked before.",
            },
            {
              label:    "B",
            ...
            },
            {
              ...
              correct:  false,
              wrongStoryText: "Diana shakes her head. 'Other artists have successfully trained Claude on their transcripts. It's a prompt problem, not a limit.'",
          ...
          wrongFeedback: "AI can capture a distinct voice precisely — but only when **Contextual Grounding** provides real examples of what makes that voice specific.",
            },
            {
              label:    "D",
          ...
          wrongFeedback: "Generic output isn't inevitable — **Prompt Specificity** unlocks the distinctive voice that separates your artist in an oversaturated market.",
          wrongStoryText: "Zoe sets down the liner notes. The console pulses: 'You accepted a silhouette when you could have handed the world a fingerprint.'",
            },
          ],
        },
          ...
          choices: [
            {
              ...
              wrongStoryText: "Diana winces. 'Having soul is a nice belief, but it's not a strategy. You must learn to direct the tools.'",
          wrongFeedback: "'Soul' is a belief, not a **Strategic Framework** — without directing AI, even the most authentic artist loses ground.",
            },
            {
              label:    "B",
              ...
              wrongStoryText: "Diana sighs. 'Worrying without action is useless. The question is how you direct the technology.'",
          wrongFeedback: "Unactionable fear isn't a strategy — **AI Augmentation** rewards those who ask 'how do I direct it?' not 'will it take me?'",
            },
            {
              label:    "C",
            ...
            },
            {
              ...
              wrongStoryText: "Diana crosses her arms. 'Ignoring the tool is not an option anymore. AI usage is part of modern craft.'",
          wrongFeedback: "In today's industry, **AI Literacy** isn't separate from craft — ignoring it means your craft quietly falls behind those who don't.",
            },
          ],
        },
      ],
      ...
      choices: [
        {
          ...
          wrongStoryText: "Zoe slumps. 'Evaluating new artists requires streaming numbers and current facts. Claude doesn't have live data access.'",
          wrongFeedback: "**Tool-Task Alignment** matters — Claude excels at synthesis, but live factual A&R research needs tools with real-time data access.",
        },
        {
          label:    "B",
          ...
          wrongStoryText: "Zoe sighs. 'Just because everyone uses it doesn't mean it's the right tool for factual lookup. Don't use ChatGPT for queries.'",
          wrongFeedback: "**Tool-Task Alignment** beats popularity — wide adoption can't compensate when a tool lacks live data for factual artist research.",
        },
        {
          label:    "C",
        ...
        },
        {
          ...
          wrongStoryText: "Zoe crosses her arms. 'Throwing the baby out with the bathwater is not adaptation. AI is useful, we just have to know its limits.'",
          wrongFeedback: "Knowing the boundary is **AI Literacy** — erasing the tool entirely ignores real, verified value AI brings to A&R workflows.",
        },
      ],
    },
