      ...
      choices: [
        {
          ...
          wrongStoryText: "Maya cringes reading 'Dear Sir/Madam.' Her VP would never reply to this. She mutters: 'I asked for professional — not a letter from 1987.'",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya winces. The email reads like a legal memo from 1987. Her VP contact won't even finish the first sentence.",
        },
      ],
      xpAward: 50,
    },
      ...
      choices: [
        {
          ...
          wrongStoryText: "Maya reads the output aloud. Her client sighs. 'We've seen this exact line on three competitor sites,' they say flatly.",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya's screen fills with exclamation points and buzzwords. Her client replies in one word: 'Meh.' She stares at the ceiling.",
        },
      ],
      xpAward: 60,
    },
      ...
      choices: [
        {
          ...
          wrongStoryText: "The new output arrives. Maya reads: 'Seamlessly intuitive.' She closes her laptop slowly. Nothing changed. The AI just tried harder to fail.",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya reads the copy. It's polished, minimal — and sounds like every SaaS startup playing dress-up. 'Too Apple-adjacent,' the client says.",
        },
      ],
      xpAward: 60,
    },
      ...
      choices: [
        {
          ...
          wrongStoryText: "The feedback arrives thorough, measured, kind. Maya's onboarding still confuses first-timers. The expert never once thought to check the clock.",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya reads five polite suggestions. None of them sting. She knows real users would've already quit. The AI never felt the pressure.",
        },
      ],
      xpAward: 60,
    },
      ...
      choices: [
        {
          ...
          wrongStoryText: "Maya takes the AI's yes and runs with it. Two weeks later, a distribution flaw surfaces. The reasoning was never visible to catch.",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya's table looks sharp in the deck. But the freemium row is missing a distribution column entirely. The structure hid what mattered most.",
        },
      ],
      xpAward: 60,
    },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      choices: [
        ...
        },
        {
          ...
          wrongStoryText: "Maya reads the tidy pros and cons. It feels like a school rubric. 'A real investor would've passed by bullet two,' she mutters.",
        },
        {
          label: "C",
          ...
          wrongStoryText: "Maya stares at the screen. Generic advice fills the page. 'I asked a skeptical investor,' she mutters, 'not a textbook.'",
        },
      ],
      xpAward: 75,
    },
      ...
      choices: [
        {
          ...
          wrongStoryText: "Maya scrolls through the prompts. Every long one still fails. 'They're not too wordy,' she realizes. 'They're just empty.'",
        },
        {
          label: "B",
        ...
        },
        {
          ...
          wrongStoryText: "Maya highlights every 'act as' in the document. Fifty prompts, same weak outputs. The phrase wasn't the problem — the emptiness behind it was.",
        },
        {
          label: "D",
          ...
          wrongStoryText: "Maya reformats a prompt perfectly — clean, structured, polished. The output is still hollow. 'Pretty container,' she sighs. 'Nothing inside.'",
        },
      ],
      xpAward: 75,
    },

    // ── NEAR-TRANSFER: Same Craft, Different Creative ─────────────────────────
    {
      id:       "w13-near-transfer",
      type:     "learn",
      location: "DESIGN STUDIO · LATE NIGHT",
      xpAward:  0,
      concept: {
        title: "Same Craft. Different Creative.",
        body:  "Arthur, a video game director, spent weeks asking AI to 'write character dialogue' for a medieval RPG. The lines came back cheesy and modern. Arthur realized he had prompt layers missing. He stopped using simple commands and built a template using the 5 layers: ROLE — A fantasy writer specializing in subtext-heavy dialogue. CONTEXT — A scene between a weary king and his plotting advisor. CONSTRAINTS — Do NOT use modern slang or overt statements of intent. Keep sentences under ten words. HOW — Make the advisor's speech slightly more formal than the king's. The output was tense, authentic, and immediately usable. Same prompt anatomy. Completely different characters.",
      },
      learnHighlight: "A great prompt is not a magic keyword or a secret spell. It's a structured container that forces the AI to narrow its infinite options to your specific intent.",
    },
      ...
      bossQuestions: [
        {
          ...
          wrongStoryText: "Maya reads Prompt A's feedback aloud. 'Solid market opportunity… consider your margins…' She closes the laptop. 'This could be about anything.'", },
          ...
          wrongStoryText: "Maya hands both prompts to her team. Prompt A returns praise. Prompt B returns problems to fix. 'Same plan,' she says. 'Different eyes.'", },
          ],
        },
        {
          ...
          wrongStoryText: "Maya counts the words in Prompt B. 'It's not long for the sake of it,' she tells her team. 'Every word is doing a job.'", },
          ...
          wrongStoryText: "Maya reads the 'freely creative' email. It sounds like every cold email she's ever ignored. 'Freedom without direction,' she mutters, 'is just noise.'", },
          ],
        },
        {
          ...
          wrongStoryText: "Maya reads the improvement suggestions. 'Start with a hook. End with a call to action.' She exhales slowly. 'This is a template, not feedback.'", },
          ...
          wrongStoryText: "Maya waits for a clarifying question. None comes. The AI delivers a generic restructure. 'It didn't know to ask,' she says. 'That was my job.'", },
          ],
        },
        {
          ...
          wrongStoryText: "Maya hits send. The feedback returns polished, generic, useless. She stares at the screen. Her actual PM reader would still be lost.", },
          ...
          wrongStoryText: "Maya gets her score: 7/10. She smiles briefly, then realizes she has no idea what to actually fix. The number told her nothing.", },
          ],
        },
        {
          ...
          wrongStoryText: "Maya pastes a wall of text. The AI responds with an equally long wall. She needed a cello solo; she got the whole orchestra.", },
          ...
          wrongStoryText: "Maya types her secret phrase. The AI responds normally. No hidden door opens. The orchestra was never waiting for a password.", },
          ...
          wrongStoryText: "Maya fills in every template field carefully. The output arrives perfectly formatted and completely unhelpful. The frame held nothing real inside.", },
          ],
        },
      ],
      xpAward: 150,
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      aiCompare: {
        ...
        choices: [
          ...
          wrongStoryText: "Maya watches ChatGPT skip dependency four entirely. The strategy looks airtight — until it isn't. One missing link, and the chain breaks.",
          },
          {
            label: "C",
          ...
          wrongStoryText: "Gemini holds every word of the document. But by step five, two dependencies have quietly vanished from its logic. Big window, narrow thread.",
          },
        ],
      },
    },
