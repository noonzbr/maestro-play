...
import { allGames } from "../lib/games/index"

// Load env variables manually from .env.local without package dependency
...
async function run() {
  console.log("🚀 Starting Local Twitter/Bluesky Bot (ESM)...")
